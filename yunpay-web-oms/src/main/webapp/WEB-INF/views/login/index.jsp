...
<!-- HighCharts -->
<script src="${baseURL }/static/BJUI/plugins/highcharts/highcharts.js"></script>
<script src="${baseURL }/static/BJUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="${baseURL }/static/BJUI/plugins/highcharts/themes/gray.js"></script>
<!-- ECharts -->
...
<body>
        ...
        <div id="bjui-hnav">
            ...
            <div id="bjui-hnav-navbar-box" >
                <ul id="bjui-hnav-navbar">                                
                    ...
                    <li value="11"><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i> 业务管理</a>
                        <div id="layout_left_tree" class="items hide" data-noinit="true">
                             ${ocstree}
                        </div>
                    </li> 
            ...
            <div class="tabsPageHeader">
                <div class="tabsPageHeaderContent">
                    <ul class="navtab-tab nav nav-tabs">
                        <li data-url="${baseURL }/sys/user/list"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                    </ul>
                </div>
    ...
    <footer id="bjui-footer"> 　Copyright &copy; 2012 Siecom.All Right Reserved.　<a href="http://www.siecom.cn/" target="_blank">深圳市至高通信技术发展有限公司</a>
    </footer>
    </div>    
</body>
</html>