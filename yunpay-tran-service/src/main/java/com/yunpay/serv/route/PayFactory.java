...
public class PayFactory implements AbstractFactory{
	...
	//支付宝支付码前两位
	private static final String ALI_PREFIX="28";
	//银联支付码前两位
	 ...
	 */
	@Override
	public QrPayService getServiceByOrderfix(String orderPrefix) {
		// TODO Auto-generated method stub
		if(orderPrefix==null){
			return null;
		}
		if(WECHAT_PREFIX.indexOf(orderPrefix)>=0){
			return wechatPayService;
		}else if(ALI_PREFIX.equals(orderPrefix)){
			return aliPayService;
		}else if(UNION_PREFIX.equals(orderPrefix)){
